...
module.exports = (function() {
  ...
  BuildView.prototype.errorMessage = function(title, message) {
    this.reset();
    this.title.addClass('error');
  ...
  BuildView.prototype.replace = function(text) {
    this.output.empty();
    this.output.append(text);
  };

  BuildView.prototype.scrollTo = function(marker) {
    var position = this.output.find('#' + marker).position();
