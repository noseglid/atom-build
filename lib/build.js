...
var LinterIntegration = require('./linter-integration');
...
export default {
      ...
      .then((targets) => {
        ...
        this.child.on('close', (exitCode) => {
          ...
          if (0 === exitCode) {
            ...
            if (atom.packages.isPackageActive('linter')) {
              console.log(this.linterIntegration);
              this.linterIntegration.addErrorsFromMatcher(this.errorMatcher);
            }
  ...
  consumeLinter: (linterInstance) => {
    this.linterIntegration = new LinterIntegration(linterInstance);
    console.log(this.linterInstance);
  }
};
