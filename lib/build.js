...
module.exports = {
  ...
  activate: function(state) {
    ...
    atom.commands.add('atom-workspace', 'build:trigger', _.bind(this.build, this));
    atom.commands.add('atom-workspace', 'build:stop', _.bind(this.stop, this));
  ...
  replace: function(value) {
    ...
    if (atom.workspace.getActiveTextEditor()) {
      var activeFile = fs.realpathSync(atom.workspace.getActiveTextEditor().getPath());
  ...
  doSaveConfirm: function(modifiedTextEditors, continuecb, cancelcb) {
    ...
    if (0 === _.size(modifiedTextEditors)) {
      continuecb();
      return;
    }

    this.saveConfirmView = new SaveConfirmView();
    this.saveConfirmView.show(function(save) {
