...
module.exports = {
  ...
  activate: function(state) {
    ...
    this.errorMatcher.on('error', this.buildView.errorMessage.bind(this.buildView, 'Error matching failed!'));

    this.errorMatcher.on('scroll', function(marker) {
      this.buildView.scrollTo(marker);
    }.bind(this));
      ...
      .then(function (targets) {
        ...
        this.child.on('close', function(exitCode) {
          ...
          if (0 === exitCode) {
            ...
            this.errorMatcher.set(t.errorMatch, this.replace(t.cwd), this.buildView.output.context.innerHTML);
