...
module.exports = (function () {
  ...
  ErrorMatcher.prototype._parse = function () {
    ...
    for (regexIndex in this.regex) {
      console.log(regexIndex, this.regex[regexIndex]);
    ...
    for (matchIndex in this.currentMatch) {
      ...
      var replace = '<b class=\"' + this.currentMatch[matchIndex].type + '\" id=\"' + this.currentMatch[matchIndex].id + '\">' + _.escape(search) + '</b>';
