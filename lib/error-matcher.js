...
module.exports = (function () {
  ...
  ErrorMatcher.prototype._parse = function () {
    ...
    for (var regexIndex = 0; this.regex.length && regexIndex < this.regex.length; regexIndex++) {
    ...
    var output = '';
    var lastEnd = 0;
    for (var matchIndex = 0; this.currentMatch.length && matchIndex <= this.currentMatch.length; matchIndex++) {
