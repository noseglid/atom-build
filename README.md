...
`preBuild`        | *[optional]*   | **JS only**. A function which will be called *before* executing `cmd`. It will be passed 1 argument: `object replacements` containing computed replacement strings. `this` will be the build configuration.
